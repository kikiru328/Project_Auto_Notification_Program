...
##TEST
schedule.every().day.at("01:40:00").do(QR)
schedule.every().day.at("01:40:30").do(check)
schedule.every().day.at("01:41:00").do(notification)
schedule.every().day.at("01:41:30").do(lunch)
schedule.every().day.at("01:42:00").do(capture)
schedule.every().day.at("01:42:30").do(magic)

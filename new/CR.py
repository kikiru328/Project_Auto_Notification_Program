...
#Test
schedule.every().day.at("19:48:00").do(QR)
schedule.every().day.at("19:49:00").do(notification)
schedule.every().day.at("19:50:00").do(check)
schedule.every().day.at("19:51:00").do(capture)
schedule.every().day.at("19:52:00").do(tkinter)
schedule.every().day.at("19:53:00").do(lunch)
